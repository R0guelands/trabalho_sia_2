...
def calculate_distances(face_landmarks):
    ...
    for i in range(num_points - 1):
        x1, y1, z1 = face_landmarks.landmark[i].x, face_landmarks.landmark[i].y, face_landmarks.landmark[i].z
        x2, y2, z2 = face_landmarks.landmark[i + 1].x, face_landmarks.landmark[i + 1].y, face_landmarks.landmark[i + 1].z
        ...
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                for face_landmarks in results.multi_face_landmarks:
                    ...
                    df = pd.concat([df, calculate_distances(face_landmarks)], ignore_index=True)
